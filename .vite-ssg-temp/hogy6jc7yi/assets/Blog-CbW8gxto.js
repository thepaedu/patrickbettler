...
import { p as posts } from "./posts-qTPuLl2W.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container page" }, _attrs))} data-v-fd619efd><h1 data-v-fd619efd>Blog</h1>`);
      if (!unref(posts).length) {
        _push(`<p class="empty" data-v-fd619efd> Noch keine Beiträge – lege Markdown-Dateien unter <code data-v-fd619efd>src/content/blog</code> an. </p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="post-grid" data-v-fd619efd><!--[-->`);
            ...
            if (_push2) {
              _push2(ssrRenderComponent(GlassCard, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (post.cover) {
                      _push3(`<img${ssrRenderAttr("src", unref(withBase)(post.cover))}${ssrRenderAttr("alt", post.title)} class="cover" data-v-fd619efd${_scopeId2}>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<time class="date" data-v-fd619efd${_scopeId2}>${ssrInterpolate(formatDate(post.date))}</time><h2 data-v-fd619efd${_scopeId2}>${ssrInterpolate(post.title)}</h2><p class="excerpt" data-v-fd619efd${_scopeId2}>${ssrInterpolate(post.excerpt)}</p>`);
                    if (post.tags.length) {
                      _push3(`<div class="tags" data-v-fd619efd${_scopeId2}><!--[-->`);
                      ssrRenderList(post.tags, (tag) => {
                        _push3(`<span class="tag" data-v-fd619efd${_scopeId2}>${ssrInterpolate(tag)}</span>`);
                      });
                      _push3(`<!--]--></div>`);
                    } else {
                      _push3(`<!---->`);
...
const Blog = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fd619efd"]]);
export {
  Blog as default
};
